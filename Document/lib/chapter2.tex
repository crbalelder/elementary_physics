\stepcounter{chapter}
\chapter{Getting Started with Programming}
    ...
    \end{problem}
    \textit{ Sol. } 
    \lstinputlisting[language=Python, caption=Seconds]{Programs/chapter2/2_1_seconds.py}
    ...
    \end{problem}
    \textit{ Sol. }
    \lstinputlisting[language=Python, caption=Spherical mass]{Programs/chapter2/2_2_Spherical_mass.py}
    ...
    \end{problem}
    \textit{ Sol. }
    \lstinputlisting[language=Python, caption= Angle]{Programs/chapter2/2_3_Angle.py}
    ...
    \end{problem}
    \textit{ Sol. } 
    \lstinputlisting[language=Python, caption = Unit vector]{Programs/chapter2/2_4_unit_vec.py}
    ...
    \end{problem}
    \textit{ Sol. }
    \lstinputlisting[language=Python, caption = Plotting the normal distribution]{Programs/chapter2/2_5__Plotting_normal.py}
    \begin{figure}[h!]
        \centering
    ...
    \end{problem}
    \textit{ Sol. }
    \lstinputlisting[language=Python, caption = Plotting 1/xn]{Programs/chapter2/2_6_Plotting_1x_n.py}
    \begin{figure}[h!]
        \centering
    ...
    \end{problem}
    \textit{ Sol. }
    \lstinputlisting[language=Python, caption=Plotting sin x / xn]{Programs/chapter2/2_7_Plotting_sinx.py}
    \begin{figure}[h!]
        \centering
    ...
    \end{problem}
    \textit{ Sol. }
    \lstinputlisting[language=Python, caption = Logistic map]{Programs/chapter2/2_8_logistic_map.py}
    \begin{figure}[h!]
        \centering
    ...
    \end{problem}
    \textit{ Sol. }
    \lstinputlisting[language=Python, caption = Euler's method]{Programs/chapter2/2_9_Euler_me.py}
    \begin{figure}[h!]
        \centering
    ...
    \begin{problem}[Throwing two dice]\label{problem_2.10}
    ...
    \end{problem}
    \textit{ Sol. }
    \lstinputlisting[language=Python, caption = Throwing two dice]{Programs/chapter2/2_10_throw_dice.py}


    \begin{problem}[Reading data]\label{problem_2.11}
    ...
    \end{problem}
    \textit{ Sol. }
    \lstinputlisting[language=Python, caption = Reading data]{Programs/chapter2/2_11_Reading.py}
    \begin{figure}[h!]
        \centering
    ...
    \begin{problem}[Numerical integration of a data-set]\label{problem_2.12}
    ...
    \end{problem}
    \textit{ Sol. }
    \lstinputlisting[language=Python, caption = Numerical integration]{Programs/chapter2/2_12_nume_inte_py}
    \begin{figure}[h!]
        \centering
